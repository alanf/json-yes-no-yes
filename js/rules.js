rules = {
	...
	'soles_fulcrum': [
                ...
                'next': 'intelligence',
                'content': 'soles.jpg',
                'position': {'x': '500px', 'y': '200px'}
                },
				{
                'type': 'image',
                'next': 'hair',
                'content': 'fulcrum.jpg',
                'position': {'x': '210px', 'y': '45px'}
                }
	],
	'hair': [
				{
	...
	'youthink': [
		...
		'orange_plant': [
                ...
                'next': 'brighter',
                'content': 'orange.jpg',
                'position': {'x': '40%', 'y': '100px'}
                },
				{
                'type': 'image',
                'next': 'doorway',
                'content': 'plant.jpg',
                'position': {'x': '15%', 'y': '100px'}
                }
	],
			'icecream': [
                {
			...
			'seaclouds': [
                ...
                'position': {'x': '25%', 'y': '80px'}
                },
				{
                'type': 'image',
                'next': 'wind',
                'content': 'clouds.jpg',
                'position': {'x': '40%', 'y': '280px'}
                }
	],
			'ground': [
                {
			...
			'24nights': [
                ...
                'next': 'devotion3',
                'content': '24_1.jpg',
                'position': {'x': '25%', 'y': '20px'}
                },
				{
                'type': 'image',
                'next': '2_1',
                'content': '24_2.jpg',
                'position': {'x': '25%', 'y': '165px'}
                },
				{
                'type': 'image',
                'next': 'light_reliance',
                'content': '24_3.jpg',
                'position': {'x': '25%', 'y': '310px'}
                },
				{
                'type': 'image',
                'next': 'hairdown_x',
                'content': '24_4.jpg',
                'position': {'x': '25%', 'y': '455px'}
                }
	],
				'devotion3': [
                {
                ...
                'position': {'x': '10%', 'y': '75px'}
                },
				{
                'type': 'image',
                'next': 'bodies5',
                'content': 'hermann2.jpg',
                'position': {'x': '10%', 'y': '375px'}
                },
				{
                'type': 'image',
                'next': 'bodies5',
                'content': 'hermann3.jpg',
                'position': {'x': '65%', 'y': '75px'}
                },
				{
                'type': 'image',
                'next': 'bodies5',
                'content': 'hermann4.jpg',
                'position': {'x': '65%', 'y': '375px'}
                }
	],
				'portland_slice': [
                {
                ...
                'next': 'history',
                'content': 'circle_1.jpg',
                'position': {'x': '450px', 'y': '30%'}
                },
				{
                'type': 'image',
                'next': 'focus_light',
                'content': 'circle_2.jpg',
                'position': {'x': '650px', 'y': '30%'}
                }
    ],
		...
		'comparisons': [
                {
                'type': 'text',
                'content': '[[start|a series of comparisons]]',
				'width': '600px',
